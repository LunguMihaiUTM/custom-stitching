...
def stitch_layered(cap, samples, K, frame_indices, device_to_opencv,
    ...
    strip_half_deg = avg_yaw_step * 1.5
    ...
    # ---- Pass 2: Multi-band blended strips ----
    ...
    for count, fi in enumerate(order):
        ...
        row_ix = rows[:, np.newaxis]
        col_ix = cols[np.newaxis, :]
        pano_patch = panorama[row_ix, col_ix]
    ...
    # No horizontal flip needed — Android IMU panorama is already correct orientation
